...
/** @type {Region[]} */
const REGIONS = [
  { code: 'hk', name: '香港',     flag: '🇭🇰', patterns: [/香港|港|\bHK\b|Hong\s?Kong|\bHKG\b/i] },
  { code: 'tw', name: '台湾',     flag: '🇹🇼', patterns: [/台湾|台北|高雄|\bTW\b|Taiwan|\bTPE\b/i] },
  { code: 'jp', name: '日本',     flag: '🇯🇵', patterns: [/日本|东京|大阪|\bJP\b|Japan|\bJPN\b|Tokyo|Osaka/i] },
  { code: 'kr', name: '韩国',     flag: '🇰🇷', patterns: [/韩国|首尔|\bKR\b|Korea|\bKOR\b|Seoul/i] },
  { code: 'sg', name: '新加坡',   flag: '🇸🇬', patterns: [/新加坡|狮城|\bSG\b|Singapore|\bSIN\b/i] },
  { code: 'us', name: '美国',     flag: '🇺🇸', patterns: [/美国|\bUS\b|United\s?States|\bUSA\b|America/i] },
  { code: 'ca', name: '加拿大',   flag: '🇨🇦', patterns: [/加拿大|\bCA\b|Canada/i] },
  { code: 'uk', name: '英国',     flag: '🇬🇧', patterns: [/英国|\bUK\b|United\s?Kingdom|Britain|London/i] },
  { code: 'de', name: '德国',     flag: '🇩🇪', patterns: [/德国|法兰克福|\bDE\b|Germany|\bGER\b/i] },
  { code: 'fr', name: '法国',     flag: '🇫🇷', patterns: [/法国|\bFR\b|France|Paris/i] },
  { code: 'nl', name: '荷兰',     flag: '🇳🇱', patterns: [/荷兰|\bNL\b|Netherlands|Holland|Amsterdam/i] },
  { code: 'ru', name: '俄罗斯',   flag: '🇷🇺', patterns: [/俄罗斯|\bRU\b|Russia|Moscow/i] },
  { code: 'tr', name: '土耳其',   flag: '🇹🇷', patterns: [/土耳其|\bTR\b|Turkey/i] },
  { code: 'au', name: '澳大利亚', flag: '🇦🇺', patterns: [/澳大利亚|澳洲|\bAU\b|Australia|Sydney/i] },
  { code: 'in', name: '印度',     flag: '🇮🇳', patterns: [/印度|\bIN\b|India/i] },
  { code: 'ar', name: '阿根廷',   flag: '🇦🇷', patterns: [/阿根廷|\bAR\b|Argentina/i] },
  { code: 'br', name: '巴西',     flag: '🇧🇷', patterns: [/巴西|\bBR\b|Brazil/i] },
  { code: 'th', name: '泰国',     flag: '🇹🇭', patterns: [/泰国|\bTH\b|Thailand/i] },
  { code: 'vn', name: '越南',     flag: '🇻🇳', patterns: [/越南|\bVN\b|Vietnam/i] },
  { code: 'ph', name: '菲律宾',   flag: '🇵🇭', patterns: [/菲律宾|\bPH\b|Philippines/i] },
  { code: 'my', name: '马来西亚', flag: '🇲🇾', patterns: [/马来西亚|\bMY\b|Malaysia/i] },
  { code: 'id', name: '印尼',     flag: '🇮🇩', patterns: [/印尼|印度尼西亚|\bID\b|Indonesia/i] },
  { code: 'ae', name: '阿联酋',   flag: '🇦🇪', patterns: [/阿联酋|迪拜|\bAE\b|\bUAE\b|Dubai/i] },
];
