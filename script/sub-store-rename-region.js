...
/** @type {Region[]} */
const REGIONS = [
  { code: 'hk', name: '香港',     flag: '🇭🇰', patterns: [/香港|港|HK|Hong\s?Kong|HKG/i] },
  { code: 'tw', name: '台湾',     flag: '🇹🇼', patterns: [/台湾|台|TW|Taiwan|TPE|台北|高雄/i] },
  { code: 'jp', name: '日本',     flag: '🇯🇵', patterns: [/日本|日|JP|Japan|JPN|Tokyo|Osaka|东京|大阪/i] },
  { code: 'kr', name: '韩国',     flag: '🇰🇷', patterns: [/韩国|韩|KR|Korea|KOR|Seoul|首尔/i] },
  { code: 'sg', name: '新加坡',   flag: '🇸🇬', patterns: [/新加坡|狮城|SG|Singapore|SIN/i] },
  { code: 'us', name: '美国',     flag: '🇺🇸', patterns: [/美国|美|US|United\s?States|USA|America/i] },
  { code: 'ca', name: '加拿大',   flag: '🇨🇦', patterns: [/加拿大|CA|Canada/i] },
  { code: 'uk', name: '英国',     flag: '🇬🇧', patterns: [/英国|英|UK|United\s?Kingdom|Britain|London/i] },
  { code: 'de', name: '德国',     flag: '🇩🇪', patterns: [/德国|德|DE|Germany|GER/i] },
  { code: 'fr', name: '法国',     flag: '🇫🇷', patterns: [/法国|法|FR|France|Paris/i] },
  { code: 'nl', name: '荷兰',     flag: '🇳🇱', patterns: [/荷兰|NL|Netherlands|Holland|Amsterdam/i] },
  { code: 'ru', name: '俄罗斯',   flag: '🇷🇺', patterns: [/俄罗斯|俄|RU|Russia|Moscow/i] },
  { code: 'tr', name: '土耳其',   flag: '🇹🇷', patterns: [/土耳其|TR|Turkey/i] },
  { code: 'au', name: '澳大利亚', flag: '🇦🇺', patterns: [/澳大利亚|澳洲|AU|Australia|Sydney/i] },
  { code: 'in', name: '印度',     flag: '🇮🇳', patterns: [/印度|IN|India/i] },
  { code: 'ar', name: '阿根廷',   flag: '🇦🇷', patterns: [/阿根廷|AR|Argentina/i] },
  { code: 'br', name: '巴西',     flag: '🇧🇷', patterns: [/巴西|BR|Brazil/i] },
  { code: 'th', name: '泰国',     flag: '🇹🇭', patterns: [/泰国|TH|Thailand/i] },
  { code: 'vn', name: '越南',     flag: '🇻🇳', patterns: [/越南|VN|Vietnam/i] },
  { code: 'ph', name: '菲律宾',   flag: '🇵🇭', patterns: [/菲律宾|PH|Philippines/i] },
  { code: 'my', name: '马来西亚', flag: '🇲🇾', patterns: [/马来西亚|MY|Malaysia/i] },
  { code: 'id', name: '印尼',     flag: '🇮🇩', patterns: [/印尼|印度尼西亚|ID|Indonesia/i] },
  { code: 'ae', name: '阿联酋',   flag: '🇦🇪', patterns: [/阿联酋|迪拜|AE|UAE|Dubai/i] },
];
